...
class mgdPostGrid
{
    ...
    {
        add_action('carbon_fields_register_fields', [$this, 'mgd_post_grid']);
    }
    ...
    function mgd_post_grid()
    {

        Block::make(__('Magical Posts Grid', 'magical-posts-display'))
            ->set_category('magical-posts-display', __('Magical Posts', 'magical-posts-display'), 'welcome-widgets-menus')
            ->set_icon('screenoptions')
            ->set_keywords([__('post', 'magical-posts-display'), __('grid', 'magical-posts-display'), __('card', 'magical-posts-display')])
            ->set_mode('both')
            ->add_tab(__('Posts Grid'), array(
                ...
                Field::make('select', 'mpdg_posts_column', __('Grid Column', 'magical-posts-display'))
                    ->set_options(array(
            ...
            ->set_render_callback(function ($fields, $attributes, $inner_blocks) {
                $rand_num = wp_rand(798548, 325894);
                ...
                $mpdg_posts_column = isset($fields['mpdg_posts_column']) ? $fields['mpdg_posts_column'] : '4';
                $mpdg_posts_img = isset($fields['mpdg_posts_img']) ? $fields['mpdg_posts_img'] : 'show-img';
                $mpdg_img_size = isset($fields['mpdg_img_size']) ? $fields['mpdg_img_size'] : 'card-grid';
...
?>
            <div class="mgpd mp-display-gird mgpdg1 mgpdg1<?php echo esc_attr($rand_num); ?> ">
                <style type="text/css">
                    <?php if ($mpdg_cont_padding || $mpdg_cont_bgcolor) : ?>.mgpdg1<?php echo esc_attr($rand_num); ?>.mgpdg1-card {
                        <?php if ($mpdg_cont_padding) : ?>padding: <?php echo esc_attr($mpdg_cont_padding); ?>px !important;
                        <?php endif; ?><?php if ($mpdg_cont_bgcolor) : ?>background: <?php echo esc_attr($mpdg_cont_bgcolor); ?>;
                        <?php endif; ?>
                    }

                    <?php endif; ?><?php if ($mpdg_img_width || $mpdg_img_height || $mpdg_img_margin) : ?>.mgpdg1<?php echo esc_attr($rand_num); ?>.mgpdg1-card img,
                    .mgpdg1<?php echo esc_attr($rand_num); ?>.mgpdg1-card .no-post-thumbnail {
                        <?php if ($mpdg_img_width == 'yes') : ?>width: 100%;
                        <?php endif; ?><?php if ($mpdg_img_height) : ?>height: <?php echo esc_attr($mpdg_img_height); ?>px;
                        <?php endif; ?><?php if ($mpdg_img_margin) : ?>margin-bottom: <?php echo esc_attr($mpdg_img_margin); ?>px;
                        <?php endif; ?>
                    }

                    <?php endif; ?><?php if ($mpdg_title_size || $mpdg_title_margin || $mpdg_title_color) : ?>.mgpdg1<?php echo esc_attr($rand_num); ?>.mgpdg1-card .card-title a,
                    .mgpdg1<?php echo esc_attr($rand_num); ?>.mgpdg1-card .card-title {
                        <?php if ($mpdg_title_size) : ?>font-size: <?php echo esc_attr($mpdg_title_size); ?>px;
                        <?php endif; ?><?php if ($mpdg_title_color) : ?>color: <?php echo esc_attr($mpdg_title_color); ?>;
                        <?php endif; ?><?php if ($mpdg_title_margin) : ?>margin-bottom: <?php echo esc_attr($mpdg_title_margin); ?>px;
                        <?php endif; ?>
                    }

                    <?php endif; ?><?php if ($mpdg_desc_size || $mpdg_desc_margin || $mpdg_desc_color) : ?>.mgpdg1<?php echo esc_attr($rand_num); ?>.mgpdg1-card .card-text {
                        <?php if ($mpdg_desc_size) : ?>font-size: <?php echo esc_attr($mpdg_desc_size); ?>px;
                        <?php endif; ?><?php if ($mpdg_desc_color) : ?>color: <?php echo esc_attr($mpdg_desc_color); ?>;
                        <?php endif; ?><?php if ($mpdg_desc_margin) : ?>margin-bottom: <?php echo esc_attr($mpdg_desc_margin); ?>px;
                        <?php endif; ?>
                    }

                    <?php endif; ?><?php if ($mpdg_meta_size || $mpdg_meta_color) : ?>.mgpdg1<?php echo esc_attr($rand_num); ?>.mp-meta,
                    .mgpdg1<?php echo esc_attr($rand_num); ?>.mp-meta a,
                    .mgpdg1<?php echo esc_attr($rand_num); ?>.mp-meta i {
                        <?php if ($mpdg_meta_size) : ?>font-size: <?php echo esc_attr($mpdg_meta_size); ?>px;
                        <?php endif; ?><?php if ($mpdg_meta_color) : ?>color: <?php echo esc_attr($mpdg_meta_color); ?>;
                        <?php endif; ?>
                    }
                ...
                <div class="mgpd-masonry">
                    <div class="row" data-masonry='{"percentPosition": true }'>
                        ...
                        ?>
                                <div class="mgpd-masonry-item col-lg-<?php echo esc_attr($mpdg_posts_column); ?>">
                                    <div class="card mgpdg1-card mb-4">

                                        <?php if ($mpdg_posts_img == 'show-img') : ?>
